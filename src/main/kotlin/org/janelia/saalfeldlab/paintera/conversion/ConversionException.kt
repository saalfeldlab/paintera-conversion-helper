...
open class InvalidInputContainer(val container: String, message: String = "Invalid input container `$container'") : ConversionException(exitCodes.INVALID_INPUT_CONTAINER, message)
open class InvalidInputDataset(val container: String, val dataset: String, message: String = "Invalid input dataset `$dataset' in `$container'") : ConversionException(exitCodes.INVALID_INPUT_DATASET, message)
...
open class InvalidOutputContainer(val container: String, message: String = "Invalid output container `$container'") : ConversionException(exitCodes.INVALID_OUTPUT_CONTAINER, message)
open class InvalidOutputDataset(val container: String, val dataset: String, message: String = "Invalid dataset `$dataset' in output container `$container'") : ConversionException(exitCodes.INVALID_OUTPUT_DATASET, message)
