    ...
    override fun call(): Int {
        ...
        return try {
            ...
            if (inputContainer == outputContainer && inputDataset == outputDataset)
                throw InvalidOutputDataset(outputContainer, outputDataset, "Input and output are the same datasets `$outputDataset' in the same container `$outputContainer'")
